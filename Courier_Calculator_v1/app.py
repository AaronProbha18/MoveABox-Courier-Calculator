...
def index():
    if request.method == 'POST':
        ...
        air_price = estimate_price(weight, length, breadth, width, destination, 'air', packaging, pickup)
        surface_price = estimate_price(weight, length, breadth, width, destination, 'surface', packaging, pickup)

        return render_template('index.html', state_mapping=state_mapping, air_price=air_price, surface_price=surface_price)
    else:
